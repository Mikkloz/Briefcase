...
var unitexture = loader.load("js/galaxy.jpg");
var universo = new THREE.SphereGeometry( 30, 60, 60 );
...
//crear venus
var venus = new planeta (0.3, "js/venus.gif");
scene.add(venus.planeta);
venus.planeta.add(label2);

//crear tierra
var tierra = new planeta (0.4, "js/map.png");
